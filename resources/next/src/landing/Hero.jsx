        ...
        <section dir="ltr" className={`${vazir.className} w-full bg-[#f8faf9]`}>
            <div className="mx-auto max-w-[1400px] px-4 lg:px-8">
                <div className="flex min-h-[650px] flex-col items-center gap-14 lg:grid lg:min-h-[700px] lg:grid-cols-[1fr_1.2fr] lg:gap-16">
                    <div dir="rtl" className="order-1 w-full text-right lg:order-2">
                        ...
                        >
                            <button
                                type="button"
                                onClick={handleLegalProblem}
                                className="w-full rounded-lg border border-[#c5a35a] bg-white px-7 py-3.5 text-sm font-bold text-[#123f37] transition-all duration-300 ease-out hover:scale-[1.04] hover:bg-[#faf6ed] hover:shadow-md active:scale-[0.98] sm:w-auto"
                            >
