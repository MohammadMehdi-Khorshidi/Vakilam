        ...
        >
            ...
            {!isLast ? (
                <button
                    type="button"
                    onClick={onNext}
                    className="flex items-center gap-2 rounded-xl bg-[#0b4138] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#08362f]"
                >
                ...
                <button
                    type="button"
                    onClick={onSubmit}
                    className="rounded-xl bg-[#0b4138] px-5 py-3 text-sm font-bold text-white"
                >
                    ثبت و ادامه مسیر
                </button>
            )}
