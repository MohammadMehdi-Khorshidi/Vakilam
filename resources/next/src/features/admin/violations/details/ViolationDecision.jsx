...
export default function ViolationDecision({ violationId }) {
        ...
        <section className="rounded-[22px] border border-[#dce5e1] bg-white p-5 shadow-[0_7px_25px_rgba(20,61,52,0.05)]">
            ...
            <div className="mt-4 flex flex-wrap justify-end gap-3">
                ...
                <button
                    ...
                    className="rounded-xl border border-[#d5dedb] bg-white px-5 py-3 text-sm font-bold text-[#173e38] transition hover:bg-[#f7f9f6]"
                >
                    ذخیره یادداشت
                </button>
                ...
                <button
                    ...
                    className="rounded-xl border border-[#d5a746] bg-[#fffcf5] px-5 py-3 text-sm font-bold text-[#173e38] transition hover:bg-[#fff7e6]"
                >
                    ارجاع برای بررسی
                </button>
