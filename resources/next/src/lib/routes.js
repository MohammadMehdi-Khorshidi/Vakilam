export const clientNav = [
    ...
    { href: '/client/case/documents', label: 'اسناد' },
    { href: '/client/contract', label: 'قرارداد و پرداخت' },
];
...
export const lawyerNav = [
    ...
    { href: '/lawyer/cases', label: 'پرونده‌ها' },
    { href: '/lawyer/messages', label: 'پیام‌ها' },
...
export const adminNav = [
    ...
    { href: '/admin/violations', label: 'تخلفات' },
