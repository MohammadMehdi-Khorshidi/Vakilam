...
import CaseDetails from '@/components/pages/dashboard/lawyer/(cases)/(caseCode)/CaseDetails';
import { getCaseDetails } from '@/components/pages/dashboard/lawyer/(cases)/(caseCode)/caseData';
