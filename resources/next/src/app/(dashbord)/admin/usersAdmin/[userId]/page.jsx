...
import { getUserById } from '@/components/pages/dashboard/admin/(users)/user-details/usersDetailsData';
import UserDetailsPage from '@/components/pages/dashboard/admin/(users)/user-details/UserDetailsPage';
