...
import { getAiErrorById } from '../../../../../components/pages/dashboard/admin/(ai-errors)/(errorId)/aiErrorDetailsData';
import AiErrorDetailsPage from '@/components/pages/dashboard/admin/(ai-errors)/(errorId)/AiErrorDetailsPage';
