...
import { getVerificationById } from '@/components/pages/dashboard/admin/(verifications)/(verificationId)/verificationDetailsData';
import VerificationDetailsPage
    from '@/components/pages/dashboard/admin/(verifications)/(verificationId)/VerificationDetailsPage';
