...
import { getCaseById } from '../../../../../components/pages/dashboard/admin/(casesAdmin)/(case-details)/caseDetailsData';
import CaseDetailsPage
    from '../../../../../components/pages/dashboard/admin/(casesAdmin)/(case-details)/CaseDetailsPage';
