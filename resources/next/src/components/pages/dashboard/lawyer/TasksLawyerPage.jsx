...
import TaskOverviewItem from '@/components/pages/dashboard/lawyer/(tasks)/TaskOverviewItem';
import { tasks } from '@/components/pages/dashboard/lawyer/(tasks)/tasksData';
