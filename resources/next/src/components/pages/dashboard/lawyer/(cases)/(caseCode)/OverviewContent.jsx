...
import ActionButton from '@/components/pages/dashboard/lawyer/(cases)/(caseCode)/ActionButton';
import InfoBox from '@/components/pages/dashboard/lawyer/(cases)/(caseCode)/InfoBox';
import RecentActivities from '@/components/pages/dashboard/lawyer/(cases)/(caseCode)/RecentActivities';
import StatCard from '@/components/pages/dashboard/lawyer/(cases)/StatCard';
