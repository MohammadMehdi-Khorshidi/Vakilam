...
import CaseInformation from '@/components/pages/dashboard/lawyer/(cases)/(caseCode)/(GeneralInformation)/CaseInformation';
import CaseTabs, {
    caseTabs,
} from '@/components/pages/dashboard/lawyer/(cases)/(caseCode)/CaseTabs';
import LastUpdatedTime from '@/components/pages/dashboard/lawyer/(cases)/(caseCode)/LastUpdatedTime';
import OverviewContent from '@/components/pages/dashboard/lawyer/(cases)/(caseCode)/OverviewContent';
import CollaborationDetails from './(WorkingRelationship)/CollaborationDetails';
...
import CaseAssistant from './(LegalAssistant)/CaseAssistant';
