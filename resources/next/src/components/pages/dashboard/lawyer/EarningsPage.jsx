...
import EarningsSummaryCard from '@/components/pages/dashboard/lawyer/(earnings)/EarningsSummaryCard';
import EarningsTable from '@/components/pages/dashboard/lawyer/(earnings)/EarningsTable';
import { earnings } from '@/components/pages/dashboard/lawyer/(earnings)/earningsData';
