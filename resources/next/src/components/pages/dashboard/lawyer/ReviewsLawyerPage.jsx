...
import ReviewsList from '@/components/pages/dashboard/lawyer/(reviews)/ReviewsList';
import ReviewsSummary from '@/components/pages/dashboard/lawyer/(reviews)/ReviewsSummary';
import { reviews } from '@/components/pages/dashboard/lawyer/(reviews)/reviewsData';
