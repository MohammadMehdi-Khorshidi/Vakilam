                ...
                >
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="h-12 w-full rounded-xl border border-[#0d302a]/15 bg-[#f8faf9] px-4 text-sm text-[#0d302a] outline-none transition placeholder:text-[#0d302a]/35 focus:border-[#c9a96e] focus:ring-2 focus:ring-[#c9a96e]/15"
                            />
                        </div>
                    ...
                    <div className="mt-5 grid grid-cols-1 gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <select
                                ...
                                onChange={handleChange}
                                required
                                className="h-12 w-full rounded-xl border border-[#0d302a]/15 bg-[#f8faf9] px-4 text-sm text-[#0d302a] outline-none transition focus:border-[#c9a96e] focus:ring-2 focus:ring-[#c9a96e]/15"
                            >
                                <option value="">
                    ...
                    <div className="mt-5">
                        ...
                        <textarea
                            ...
                            required
                            rows={6}
                            className="w-full resize-none rounded-xl border border-[#0d302a]/15 bg-[#f8faf9] px-4 py-4 text-sm leading-7 text-[#0d302a] outline-none transition placeholder:text-[#0d302a]/35 focus:border-[#c9a96e] focus:ring-2 focus:ring-[#c9a96e]/15"
                        />
                    </div>
